...
class rbtestAppDelegate < OSX::NSObject
	...
	# file. This code uses a directory named "rbtest"
	...
	def applicationFilesDirectory
		...
		return libraryURL.URLByAppendingPathComponent_("rbtest")
	end
	...
	def managedObjectModel
		...
		modelURL = OSX::NSBundle.mainBundle.URLForResource_withExtension_("rbtest", "momd")
	...
	ok, error = fileManager.createDirectoryAtPath_withIntermediateDirectories_attributes_error_(applicationFilesDirectory.path, true, nil)
		...
		url = applicationFilesDirectory.URLByAppendingPathComponent_("rbtest.storedata")
